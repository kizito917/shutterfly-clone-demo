...
class AssetService {
   ...
   * </Note>
   */
  static createAssetUploadJob(options) {
   ...
   */
  static getAssetUploadJob(options) {
    return (options?.client ?? client).get({
      ...options,
...
class AutofillService {
   ...
   * </Note>
   */
  static createDesignAutofillJob(options) {
    return (options?.client ?? client).post({
      ...options,
      headers: {
        "Content-Type": "application/json",
   ...
   * You might need to make multiple requests to this endpoint until you get a `success` or `failed` status. For more information on the workflow for using asynchronous jobs, see [API requests and responses](https://www.canva.dev/docs/connect/api-requests-responses/#asynchronous-job-endpoints).
   */
  static getDesignAutofillJob(options) {
    return (options?.client ?? client).get({
      ...options,
...
class BrandTemplateService {
   ...
   */
  static listBrandTemplates(options) {
    return (options?.client ?? client).get({
      ...options,
   ...
   */
  static getBrandTemplate(options) {
    return (options?.client ?? client).get({
      ...options,
   ...
   * WARNING: Chart data fields are a [preview feature](https://www.canva.dev/docs/connect/#preview-apis). There might be unannounced breaking changes to this feature which won't produce a new API version.
   */
  static getBrandTemplateDataset(options) {
    return (options?.client ?? client).get({
      ...options,
...
class ConnectService {
   ...
   */
  static getSigningPublicKeys(options) {
    return (options?.client ?? client).get({
      ...options,
      url: "/v1/connect/keys",
    });
...
class DesignService {
   ...
   */
  static getDesignExportFormats(options) {
    return (options?.client ?? client).get({
      ...options,
...
class DesignImportService {
   ...
   * </Note>
   */
  static createDesignImportJob(options) {
    return (options?.client ?? client).post({
      ...options,
      headers: {
        "Content-Type": "application/octet-stream",
   ...
   * You might need to make multiple requests to this endpoint until you get a `success` or `failed` status. For more information on the workflow for using asynchronous jobs, see [API requests and responses](https://www.canva.dev/docs/connect/api-requests-responses/#asynchronous-job-endpoints).
   */
  static getDesignImportJob(options) {
    return (options?.client ?? client).get({
      ...options,
...
class ExportService {
  /**
   * Starts a new [asynchronous job](https://www.canva.dev/docs/connect/api-requests-responses/#asynchronous-job-endpoints) to a file from Canva. Once the exported file is generated, you can download
   * it using the link(s) provided.
   *
   * The request requires the design ID and the exported file format type.
   *
   * Supported file formats (and file type values): PDF (`pdf`), JPG (`jpg`), PNG (`png`), GIF (`gif`), Microsoft PowerPoint (`pptx`), and MP4 (`mp4`).
   *
   * <Note>
   *
   * For more information on the workflow for using asynchronous jobs, see [API requests and responses](https://www.canva.dev/docs/connect/api-requests-responses/#asynchronous-job-endpoints). You can check the status and get the results of jobs created with this API using the [Get design job API](https://www.canva.dev/docs/connect/api-reference/exports/get-design-export-job/).
   *
   * </Note>
   */
  static createDesignExportJob(options) {
    return (options?.client ?? client).post({
      ...options,
      headers: {
        "Content-Type": "application/json",
  ...
  /**
   * Gets the result of a design job that was created using the [Create design job API](https://www.canva.dev/docs/connect/api-reference/exports/create-design-export-job/).
   *
   ...
   * You might need to make multiple requests to this endpoint until you get a `success` or `failed` status. For more information on the workflow for using asynchronous jobs, see [API requests and responses](https://www.canva.dev/docs/connect/api-requests-responses/#asynchronous-job-endpoints).
   */
  static getDesignExportJob(options) {
    return (options?.client ?? client).get({
      ...options,
...
class FolderService {
   ...
   */
  static listFolderItems(options) {
    return (options?.client ?? client).get({
      ...options,
...
class OauthService {
   ...
   */
  static exchangeAccessToken(options) {
    return (options?.client ?? client).post({
      ...options,
      ...urlSearchParamsBodySerializer,
      headers: {
   ...
   * This endpoint can't be called from a user's web-browser client because it uses client authentication with client secrets. Requests must come from your integration's backend, otherwise they'll be blocked by Canva's [Cross-Origin Resource Sharing (CORS)](https://developer.mozilla.org/en-US/docs/Web/HTTP/CORS) policy.
   */
  static introspectToken(options) {
    return (options?.client ?? client).post({
      ...options,
      ...urlSearchParamsBodySerializer,
      headers: {
